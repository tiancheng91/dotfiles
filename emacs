...
(custom-set-faces
 ...
 '(org-table ((t nil)))
 '(sieve-action-commands ((t nil)))
 '(sieve-control-commands ((t nil)))
 '(sieve-tagged-arguments ((t nil)))
 '(sieve-test-commands ((t nil)))
